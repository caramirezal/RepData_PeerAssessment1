...
## plotting results
png("instructions_fig/distributionSteps.png")
...
![](instructions_fig/distributionSteps.png)

As can be seen the data is sparce. Additionally, the more frequent number of dairy steps is around one thousand steps.
...
## plotting the data
png("instructions_fig/meanMedian.png")
par( mar= c(5,5,5,5))
...
![](instructions_fig/meanMedian.png)
...
dev.off()
```
![](instructions_fig/averageStepsTimeSeries.png)
...
## plotting results
png("instructions_fig/stepsDistributionInputed.png")
...
![](instructions_fig/stepsDistributionInputed.png)
...
png("instructions_fig/meanMedianInputedData.png")
par(mar=c(5,5,5,5))
plot(dates,means.in,
...
dev.off()
```
![](instructions_fig/meanMedianInputedData.png)
...
```{r, results='hide'}
## calculating the total of steps in the inputed data 
steps <- with(activity.inputed,tapply(steps,date,sum))

## plotting the data
png("instructions_fig/distributionStepsInputedData02.png")
hist(steps,breaks = 50,col = "steelblue",
     main = "Number of dairy steps distribution (inputed data)",
     xlab = "Number of steps")
dev.off()
```
![](instructions_fig/distributionStepsInputedData02.png)
...
png("instructions_fig/averageStepsByWeekDay.png")
par(mfrow=c(1,2))
par(mar=c(5,5,5,5))
...
![](instructions_fig/averageStepsByWeekDay.png)

From the plot above it can be seen that the studied subject is more active on weekends in terms of the average of steps.

### **9. All of the R code needed to reproduce the results (numbers, plots, etc.) in the report**

All the scripts are provided in the PA1_template.Rmd file included of the https://github.com/caramirezal/RepData_PeerAssessment1 github project.
